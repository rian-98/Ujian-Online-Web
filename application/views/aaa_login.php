...
<head>
<meta charset="utf-8">
<title>Ulangan Harian - Rian</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<meta name="description" content="UMBKS - MI/MTs/MA - ">
<meta name="apple-mobile-web-app-capable" content="yes">
<link href="<?php echo base_url(); ?>___/css/bootstrap.css" rel="stylesheet">
<link href="<?php echo base_url(); ?>___/css/style.css" rel="stylesheet">
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>___/img/download.jpg">
</head>
<body>
...
<div class="container">
	...
	<form action="" method="post" name="fl" id="f_login" onsubmit="return login();">
		...
		<p align="center" style="padding-top: 10px"><img src="../___/img/download.jpg" height="100vw"/></p>
			<div class="panel-heading"><h4 align="center" style="margin: 5px"><b>LOGIN APLIKASI</b></h4></div>
			<div class="panel-body">
				...
				<div class="login-actions">
					<button class="button btn btn-success col-lg-12 top15"><b>LOGIN APLIKASI</b></button>
				</div> <!-- .actions -->
			</div>
		</div> <!-- /login-fields -->
...
<div class="ctr"> 
	<b><a style="color: #000; text-decoration: none;" href="<?php echo base_url(); ?>adm"><?php echo $this->config->item('nama_aplikasi')." ".$this->config->item('versi'); ?></a></b>
</div>
...
<div class="col-md-12 footer" style="background-color: #0B6623; color: #fff;">
	 ...
	 <br> Ujian Berbasis Komputer & Smartphone <br> copyleft &copy UMBKS" ?>
</div>
